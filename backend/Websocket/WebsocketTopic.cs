...
public class WebsocketTopic
{
    ...
    public static readonly WebsocketTopic UsenetHealthCheckConnections = new("hcx", TopicType.State);
    ...
    public static readonly WebsocketTopic RepointSymlinksTaskProgress = new("rpsl", TopicType.State);
